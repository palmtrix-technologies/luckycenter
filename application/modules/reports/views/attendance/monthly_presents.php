            ...
            <div class="col-sm-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                          ...
                          <?php echo  form_open('reports/attendance_report/monthly_presents','id="form"') ?>
                     ...
                     <div class="form-group row">
                          <div class="col-sm-8 text-center">
                            <button type="button" onclick="checkfieldsmonthlymissrep()" class="btn btn-success w-md m-b-5"><?php echo display('search') ?></button>
                        </div>
                     </div>
                     <?php echo form_close() ?>
     ...
     <div class="row">
         <div class="col-sm-12 col-md-12">
            <div class="panel ">
                <div class="panel-heading" >
                    <div class="panel-title">
                        <span class="text-left"><?php echo display('monthly_presents') ?>(<?php $m = $year.'-'.$month.'-'.'01';
                       $yrdata= strtotime($m);
                ...
                <div class="panel-body" id="printArea">
                  <table class="table table-responsive table-hover">
                    ...
                    <tbody>
                      ...
                      $daily_presant  = $this->attendance_model->monthly_present_data($employee_id,$department_id,$data);
                        $checkweekend = $this->attendance_model->find_weekend($data);?>
                          <tr><td colspan="6" class="text-center"><h2><?php echo $data;?></h2></td></tr>
                         <?php 
                                 if($checkweekend < 1){
                           $sl = 1;
                            foreach ($daily_presant as $result) {
