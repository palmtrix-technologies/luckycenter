          ...
          <div class="col-sm-12 col-md-12">
            <div class="panel">
              ...
              <div class="panel-body">
               ...
               <div class="form-group row">
               <div class="col-sm-9">
                  <b><input type="radio" name="typ" id="typ1" value="percentage"  checked onchange="funch(0)">Percentage  <input type="radio" name="typ" value="amount" id="typ2" onchange="funch(1)">Amount</b>
                  
                  </div>
               </div>
             </div>
             <table  border="1" width="100%" id="percentagetable">
              <div class="row">
                ...
                <td class="col-sm-6 text-center"><h4 class="addition_title"><?php echo display('addition')?></h4><br>
                 ...
                 foreach ($slname as $ab){
                  ?>
                  <tr><th class="padten"><?php echo $ab->sal_name ;?><span id="percental<?php echo $x;?>">(%)</span></th><td><input type="number" name="amount[<?php echo $ab->salary_type_id; ?>]" class="form-control addamount" onkeyup="salarySetupsummary()" id="add_<?php echo $x;?>"></td></tr>
                  <?php
                $x++;}
                ?>
              </table>
            ...
            <td class="col-sm-6 text-center"><h4 class="addition_title"><?php echo display('deduction')?></h4><br>
              <table id="dduct">
                ...
                foreach ($sldname as $row){
                  ?>
                  <tr><th class="padten"><?php echo $row->sal_name ;?> <span id="percentdd<?php echo $y;?>">(%)</span></th><td><input type="number" name="amount[<?php echo $row->salary_type_id; ?>]" onkeyup="salarySetupsummary()" class="form-control deducamount" id="dd_<?php echo $y;?>"></td></tr><?php
               $y++; }
                ?>
                
                <tr><th class="padten"><?php echo display('tax')?> <span id="percent3">(%)</span></th><td><input type="number" name="amount[]"  onkeyup="salarySetupsummary()"  class="form-control deducamount" id="taxinput"></td><td class="padten"><input type="checkbox" name="tax_manager" id="taxmanager" onchange='handletax(this);' value="1">Tax Manager</td></tr>

              </table>
                  <input type="hidden" value="<?php echo $x;?>" name="txtx" id="txtx">
                  <input type="hidden" value="<?php echo $y;?>" name="txty" id="txty">
            </td> 
