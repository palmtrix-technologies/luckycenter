            ...
            <td class="col-sm-6 text-center"><h4 class="addition_title">Deduction</h4><br>
              <table id="dduct">
                ...
                foreach ($samlft as $row){
                  ...
                  ?>
                  <tr><th class="padten"><?php echo $row->sal_name ;?> (%)</th><td><input type="number" name="amount[<?php echo $row->salary_type_id; ?>]" onkeyup="salarySetupsummary()" class="form-control deducamount" value="<?php echo $row->amount ?>" id="dd_<?php echo $y;?>"></td></tr><?php
               $y++; }
                ?>
                <tr><th class="padten">Tax (%)</th><td><input type="number" name="amount[]"  onkeyup="salarySetupsummary()"  class="form-control deducamount" id="taxinput" <?php if($EmpRate->rate_type==1){
                    echo 'readonly';
