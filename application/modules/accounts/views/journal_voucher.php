...
<div class="row">
   ...
   <option value="<?php echo $acc1->HeadCode;?>"><?php echo $acc1->HeadName;?></option>
         <?php }?>
                                        ...
                                        <td><input type="number" name="txtAmount[]" value="0" class="form-control total_price text-right"  id="txtAmount_1" onkeyup="calculationJournalv(1)" >
                                           </td>
                                            <td ><input type="number" name="txtAmountcr[]" value="0" class="form-control total_price1 text-right"  id="txtAmount1_1" onkeyup="calculationJournalv(1)" >
                                           </td>
                                       <td>
