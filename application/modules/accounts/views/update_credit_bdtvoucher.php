...
<div class="row">
                            ...
                            <table class="table table-bordered table-hover" id="debtAccVoucher"> 
                                ...
                                <tbody id="creditvoucher">
                                   <?php
                                    ...
                                    <tr>
                                        <td class="">  
       <select name="cmbCode[]" id="cmbCode_<?php echo $sl; ?>" class="form-control" onchange="load_codeCreditv(this.value,<?php echo $sl; ?>)">
   ...
   <option value="<?php echo $acc1->HeadCode;?>" <?php if($upcrvoucher->COAID == $acc1->HeadCode){
         ...
         <?php }?>
                                        ...
                                        <td><input type="text" name="txtAmount[]" value="<?php echo $upcrvoucher->Credit ?>" class="form-control total_price"  id="txtAmount_<?php echo $sl; ?>" onkeyup="calculationCreditv(<?php echo $sl; ?>)" >
                                           </td>
                                       <td>
                                                <button  class="btn btn-danger red" type="button" value="<?php echo display('delete')?>" onclick="deleteRowCreditv(this)"><i class="fa fa-trash-o"></i></button>
                                            </td>
                                    </tr>                              
                              <?php       $sl++;   }?>
                                </tbody>                               
