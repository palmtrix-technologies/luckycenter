                   ...
                   <table border="0" width="100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center" class="trialcommon">
                                                     ...
                                                     <td align="right" class="trialcommon">
                                                        <date>
                    ...
                    <table width="100%" class="table_boxnew">
                        <tr>
                        ...
                        <tr class="table_head">
                            ...
                            <td width="15%" align="center" class="trialtotalcredit"><strong><?php echo display('credit');?></strong></td>
                        </tr>
                        <?php
                            $TotalCredit=0;
                            $TotalDebit=0;  
                        ...
                        <tr class="table_data">
                          <td  align="left" bgcolor="<?php echo $bg;?>" class="trialsecondclass">&nbsp;</td>
                           <td  align="left" bgcolor="<?php echo $bg;?>" class="trialsecondclass">Profit-Loss</td>
                         <?php
                        }
                         if($ProfitLoss<0)
                         {
                        ...
                        <tr class="table_head">
                          <td colspan="2" align="right" class="trialbaltotal"><strong>Total</strong></td>
                          <td align="right" class="trialbaltotal"><strong><?php echo number_format($TotalDebit,2); ?></strong></td>
                          ...
                          <td colspan="4" align="center">
                            <table width="100%" cellpadding="1" cellspacing="20" >
                                <tr>
                                    ...
                                    <td width="20%" class="acc_cashflow_commonborder" align="center"><?php echo display('accounts');?></td>
