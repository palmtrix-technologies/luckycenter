   ...
   <option value="<?php echo $acc1->HeadCode;?>"  <?php if($debitvoucher->COAID ==$acc1->HeadCode){
    echo 'selected';
         ...
         <?php }?>
                                        ...
                                        <td><input type="text" name="txtAmount[]" value="<?php echo $debitvoucher->Debit;?>" class="form-control total_price"  id="txtAmount_<?php echo $sl; ?>" onkeyup="calculationDebtv(<?php echo $sl; ?>)" >
                                           </td>
                                       <td>
