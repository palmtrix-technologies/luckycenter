                        ...
                        <div class="panel-body" id="payslip">
                            <div class="row" >
                                ...
                                <div class="col-sm-12">
                                	...
                                	<table>
                                		<tr>
                                			<td><img src="assets/img/icons/2017-07-22/HRM.png" width="250px;" alt=""></td>
                                			<td class="text-center"> <address >
                                        <strong >Lucky center </strong><br>
                                        Al Jerf Industrial 1 - Ajman - United Arab Emirates<br>
                                       <span> Salary Slip - November 2019</span>
                        ...
                        <div class="col-sm-12">
                        	<table class="table">
                        		<tr>
                                    ...
                                    <thead>
                                        <tr class="employee">
                                            <th class="name text-center" colspan="2" ><?php echo 'Earnings'; ?></th>
                                    ...
                                    <tbody class="details">
                                        ...
                                        <tr class="entry nti">
                                             <td class="value">Total Addition</td>
                                            <td class="value" ><?php echo 55000; ?></td>
                                        </tr>
                                    ...
                                    <thead>
                                        <tr class="employee">
                                            <th class="name text-center" colspan="2"><?php echo 'Deduction'; ?></th>
                                    ...
                                    <tbody class="details">
                                        ...
                                        <tr class="entry">
                                         ...
                                         <tr class="entry nti">
                                             <td class="value" >Total Deduction</td>
                                            <td class="value" ><?php echo 7000; ?></td>
                                        </tr>
                                    </tbody>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <table class="table">
                                            ...
                                            <tr class="details">
                                                ...
                                                <td class="value"><?php echo 48000; ?> </td>
                                                </tbody>
                                            </tr>
                             ...
                             <div class="row">
                                <div class="col-sm-12" >
                                        ...
                                        <div class="col-sm-6" >Check No: 234252342</div><div class="col-sm-6">Name of Bank: Bangladesh Bank</div>
