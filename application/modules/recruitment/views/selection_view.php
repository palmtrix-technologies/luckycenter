                            ...
                            <?php foreach ($selection as $que) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <?php if($this->permission->method('recruitment','update')->access()): ?> 
                                        <a href="<?php echo base_url("recruitment/Candidate_select/update_selection_form/$que->can_sel_id") ?>" class="btn btn-xs btn-success"><i class="fa fa-pencil"></i></a> 
                                        <?php endif; ?>
                                    
                                    <?php if($this->permission->method('recruitment','delete')->access()): ?> 
                                        <a href="<?php echo base_url("recruitment/Candidate_select/delete_selection/$que->can_sel_id") ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>') "><i class="fa fa-trash"></i></a> 
                                         <?php endif; ?>
                                    </td>
                                </tr>
                                <?php $sl++; ?>
